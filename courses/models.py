...
########################
# Program Managing and Program Model
...
class Program(models.Model):
    ...
    objects = ProgramManager() #Program Manager Object Creation
...
########################
# Course Managing, Course Model, and Course Allocation Model
...
class Course(models.Model):
    ...
    objects = CourseManager() #Course Manager Object Creation
